...
- Микрозелень (срез и лотки): руккола, базилик, шпинат, брокколи, редис, горох, подсолнечник, кресс-салат, кинза, свёкла
- Бейби-лиф: руккола, шпинат, мангольд
- Салатные миксы: фитнес-микс, руккола, витаминный
- Съедобные цветы для ресторанной подачи: микс, настурция, бораго
- Наборы: "Ресторатор" (для бизнеса), "Фитнес/Детокс" (для здоровья)
