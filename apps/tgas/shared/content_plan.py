...
CONTENT_PILLARS: list[dict] = [
    ...
    },
    {
        ...
        "lang": "mix",
        "angle": "Концентрат пользы: почему микрозелень в 40 раз полезнее взрослой зелени. "
        "Польза для иммунитета, свежести кожи и легкости. Только факты.",
        "tags": "#витамины #суперфуд #энергия #молодость",
    },
    {
