    ...
    async with aiohttp.ClientSession() as s:
        ...
        for msg in messages:
            if msg.get("from", {}).get("username") != "microgreenuzbekistan":
                recipient = msg["from"]
                print(f"  Latest sender: {recipient.get('username')} (ID: {recipient.get('id')})")
                break
        ...
        payload6 = {
            ...
            "message": {"text": "Zdravstvuyte! Spasibo za vashe soobshchenie. Nash menedzher svyazhetsya s vami."},
