...
def fin_menu_kb():
    ...
    b.row(InlineKeyboardButton(text="💸 Расход", callback_data="fin:expense"), InlineKeyboardButton(text="💰 Доход", callback_data="fin:income"))
    b.row(InlineKeyboardButton(text="📊 P&L Отчёт", callback_data="fin:pnl"), InlineKeyboardButton(text="🏦 Баланс", callback_data="fin:balance"))
    b.row(InlineKeyboardButton(text="💳 Дебиторка", callback_data="fin:debts"), InlineKeyboardButton(text="💼 Зарплаты", callback_data="fin:salary"))
