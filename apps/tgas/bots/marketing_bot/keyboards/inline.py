...
def mkt_menu_kb(lang="ru"):
    ...
    b.row(InlineKeyboardButton(text="📢 Создать рассылку", callback_data="mkt:campaign"),
          InlineKeyboardButton(text="🏷️ Создать акцию", callback_data="mkt:promo"))
    b.row(InlineKeyboardButton(text="👥 Сегменты", callback_data="mkt:segments"),
          InlineKeyboardButton(text="📊 Аналитика", callback_data="mkt:analytics"))
    b.row(InlineKeyboardButton(text="💡 AI идеи", callback_data="mkt:ideas"),
