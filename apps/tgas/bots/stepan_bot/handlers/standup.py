...
async def standup_start(cb: CallbackQuery, state: FSMContext) -> None:
...
async def standup_y(msg: Message, state: FSMContext) -> None:
...
async def standup_t(msg: Message, state: FSMContext) -> None:
...
async def standup_b(msg: Message, state: FSMContext) -> None:
