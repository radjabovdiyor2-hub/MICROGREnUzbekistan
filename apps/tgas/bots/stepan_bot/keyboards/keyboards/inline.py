...
def pm_menu_kb(lang="ru"):
    ...
    if lang == "uz":
        b.row(InlineKeyboardButton(text="✅ Vazifa yaratish", callback_data="pm:create_task"),
              InlineKeyboardButton(text="📋 Vazifalarim", callback_data="pm:my_tasks"))
        b.row(InlineKeyboardButton(text="🌱 Ishlab chiqarish", callback_data="pm:production"),
              InlineKeyboardButton(text="🚚 Logistika", callback_data="pm:logistics"))
        b.row(InlineKeyboardButton(text="📦 Inventarizatsiya", callback_data="pm:inventory"),
              InlineKeyboardButton(text="📝 Standup", callback_data="pm:standup"))
        b.row(InlineKeyboardButton(text="📊 Loyiha sharhi", callback_data="pm:overview"),
              InlineKeyboardButton(text="🌐 Til", callback_data="pm:lang"))
    else:
        b.row(InlineKeyboardButton(text="✅ Создать задачу", callback_data="pm:create_task"),
              InlineKeyboardButton(text="📋 Мои задачи", callback_data="pm:my_tasks"))
        b.row(InlineKeyboardButton(text="🌱 Производство", callback_data="pm:production"),
              InlineKeyboardButton(text="🚚 Логистика", callback_data="pm:logistics"))
        b.row(InlineKeyboardButton(text="📦 Инвентаризация", callback_data="pm:inventory"),
              InlineKeyboardButton(text="📝 Standup", callback_data="pm:standup"))
        b.row(InlineKeyboardButton(text="📊 Обзор проекта", callback_data="pm:overview"),
