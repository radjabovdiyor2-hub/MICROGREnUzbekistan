...
FAQ = [
    ...
    # Порог — из настроек: вписанный числом, он замерзает, а владелец правит
    # его в админке и не догадывается, что бот называет старый.
    ("Доставка?", f"Бесплатно от {settings.free_delivery_threshold:,} сум по Самарканду.".replace(",", " ")),
