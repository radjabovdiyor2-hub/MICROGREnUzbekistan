...
def an_menu_kb(lang="ru"):
    ...
    b.row(InlineKeyboardButton(text="📊 Дашборд продаж", callback_data="an:dashboard"),
          InlineKeyboardButton(text="🏆 Топ товаров", callback_data="an:top"))
    b.row(InlineKeyboardButton(text="👥 Клиенты", callback_data="an:customers"),
          InlineKeyboardButton(text="📈 Прогнозы", callback_data="an:forecast"))
    b.row(InlineKeyboardButton(text="📋 ABC-анализ", callback_data="an:abc"),
