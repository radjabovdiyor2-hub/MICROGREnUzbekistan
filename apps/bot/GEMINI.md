...
## Handling Mistakes
- If routing fails, check the router registration order in `main.py`. Priority MUST be: admin → start → shop → unified → orders → agronomist → group.
