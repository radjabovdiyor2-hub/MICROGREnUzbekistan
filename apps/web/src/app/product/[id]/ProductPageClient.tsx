...
import {
  AlertTriangle, ArrowLeft, CheckCircle, ChevronRight, ClipboardList, Clock, FileText, Flame, Folder, Heart, Home, Leaf, MapPin, MessageSquare, Minus, Package, Phone, Plus, Send, ShoppingCart, Sparkles, Star, Truck, XCircle, Zap,
} from 'lucide-react';
