...
export interface PracticeView {
  key: string;
  /**
   * ОБЕ ВЕРСИИ, а не одна. Раньше сюда клалась русская строка — сервер
   * решал, на каком языке читает человек, и узбекский владелец получал
   * двести семьдесят девять практик на чужом языке при полностью
   * узбекском экране. Тот же дефект, что был у подписи воронки клиентов.
   */
