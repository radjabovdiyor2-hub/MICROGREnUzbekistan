...
import { BarChart, AlertTriangle, Download, Package, CreditCard, ClipboardList, ShoppingCart, Users, Wallet } from 'lucide-react';
    ...
    <div className="card" style={{ padding: 'var(--space-4)' }}>
      ...
      <div style={{ display: 'flex', gap: 'var(--space-2)', flexWrap: 'wrap' }}>
        {[
          ...
          // унести в таблицу: клиентской базы, заказов и денег.
