            ...
            <tr key={o.id} style={{ borderBottom: '1px solid var(--border-color)' }}>
              ...
              <td style={{ padding: 'var(--space-2)' }}>
                {o.paidAt ? (
                  ...
                  <button onClick={() => markPaid(o.id)} style={{ padding: '4px 8px', borderRadius: '4px', background: 'var(--warning-bg)', color: 'var(--warning)', border: 'none', cursor: 'pointer' }}>Оплатить</button>
                )}
              </td>
              <td style={{ padding: 'var(--space-2)' }}>
