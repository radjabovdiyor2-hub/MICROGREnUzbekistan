...
// сбивает его хром: подтверждение операции выглядело как ошибка
// операционной системы.
//
// Хуже всего было в самом частом месте: восемь `alert()` в кассе — потоке,
// который повторяется десятки раз в день, с телефона, одной рукой.
//
// СТАЛО
//
