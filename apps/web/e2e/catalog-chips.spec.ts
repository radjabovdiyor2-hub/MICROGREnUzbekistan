...
// Порядок повторяет CATALOG_SECTIONS: сначала «что это», потом «для кого».
// FAOL, ISHDA и MEHMON появились в сентябре 2026 вместе с миксами под линейки
// — повод покупки у зала, рабочего стола и стола для гостей разный настолько,
// что фильтр «для кого» без них врал.
const EXPECTED = [
  "all",
  "microgreens",
  "baby-leaf",
