...
const sharedSpec = {
  blocks: [
    ...
    // ── ОБЩЕЕ: нутрициолог ──
    {
      ...
      // «В 40 раз больше, чем во взрослой редиске» убрано: цифра ниоткуда.
      // По нашей же таблице у микрозелени редиса 38 мг/100 г — её и называем.
      fact: 'В болгарском перце витамина С в 3 раза больше, чем в лимоне. В микрозелени редиса — 38 мг на 100 г.',
