...
|--------|------|------|--------|
| `apps/web` | Next.js 16.3, React 19, TailwindCSS v4, Prisma | PWA: витрина, каталог, корзина, админка, журнал FRESH WEEKLY, 32 API-групп, 133 route-файлов, 309 компонентов | ~66KB globals.css, 92 Prisma-моделей |
