...
|--------|------|------|--------|
| `apps/web` | Next.js 16.3, React 19, TailwindCSS v4, Prisma | PWA: витрина, каталог, корзина, админка, журнал FRESH WEEKLY, 31 API-групп, 132 route-файлов, 309 компонентов | ~66KB globals.css, 92 Prisma-моделей |
