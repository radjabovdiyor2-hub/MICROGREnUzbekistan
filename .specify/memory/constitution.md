...
|--------|------|------|--------|
| `apps/web` | Next.js 16.3, React 19, TailwindCSS v4, Prisma | PWA: витрина, каталог, корзина, админка, журнал FRESH WEEKLY, 30 API-групп, 119 route-файлов, 275 компонентов | ~66KB globals.css, 86 Prisma-моделей |
...
| `packages/database` | Prisma ORM, PostgreSQL | Схема (86 моделей, 2711 строк), миграции, сиды | schema.prisma — единый источник DDL |
...
| Файл | Что содержит |
|------|-------------|
| `packages/database/prisma/schema.prisma` | 86 моделей, 2711 строк — полная схема БД |
