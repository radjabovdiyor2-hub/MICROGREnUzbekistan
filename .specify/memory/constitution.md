...
|--------|------|------|--------|
| `apps/web` | Next.js 16.3, React 19, TailwindCSS v4, Prisma | PWA: витрина, каталог, корзина, админка, журнал FRESH WEEKLY, 29 API-групп, 120 route-файлов, 275 компонентов | ~66KB globals.css, 80 Prisma-моделей |
