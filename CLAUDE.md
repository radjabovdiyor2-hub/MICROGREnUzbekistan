...
| Модуль | Стек | Роль |
|--------|------|------|
| `apps/web` | Next.js 16.3, React 19, TailwindCSS v4, Prisma | PWA: витрина, каталог, корзина, админка, журнал FRESH WEEKLY. 29 API-групп, 121 роутов |
...
| `packages/database` | Prisma, PostgreSQL | `schema.prisma` — 82 моделей, единый источник DDL |
