...
}).connect({ host:'82.115.50.30', username:'ubuntu', password:'izxir(Kpaqfmsvaamtw8', algorithms:{serverHostKey:['ssh-ed25519','ecdsa-sha2-nistp256','ssh-rsa']}, hostVerifier:()=>true });
