...
| Двуязычность оставшихся экранов админки | Переведены заказы, остатки, поставщики, смены, сотрудники. Осталось ~17 экранов, где кнопка языка по-прежнему ничего не меняет | Средний, механический |
