...
| Снизить поток сообщений владельцу | Наполовину сделано: шесть отчётов аналитики сведены в дайджест, утренняя пачка B2B решается одним нажатием, уточнение продажи спрашивает всё сразу. Остались плановые доклады остальных отделов | Средний |
| `mypy` на обработчиках aiogram | Двери к данным и машинерия вокруг них закрыты (26 путей, проверка блокирующая). В обработчиках типов нет; список в `check_types.py` растёт по мере разбора | Средний |
